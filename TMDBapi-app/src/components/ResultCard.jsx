...
// URL base para imagens da TMDB (w200 é um bom tamanho para miniaturas)
const IMAGE_BASE_URL = "https://image.tmdb.org/t/p/w200";

export default function ResultCard() {
  const { state } = useContext(AppContext);

  // Se o status não for 'done' ou se não houver resultados, não renderiza nada.
  // CORREÇÃO: Adicionamos a verificação para garantir que state.results exista antes de tentar ler o .length
        ...
        {state.results.map((movie) => (
          <ListGroup.Item key={movie.id} className="d-flex align-items-start p-3">
            ...
            <div className="flex-grow-1">
                ...
                <p className="small text-truncate" style={{ maxHeight: '4.5em', overflow: 'hidden' }}>
